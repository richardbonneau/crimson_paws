...
@onready var tower_visuals:Node3D = get_parent().get_node("Visuals").get_child(0)
...
func _process(_delta:float)->void:
	...
	if current_target: parent.look_at(current_target.global_transform.origin)
...
func find_enemy_in_range_furthest_in_maze()->Node3D:
...
func change_in_enemy_in_range()->void:
...
func shoot_at_enemy() -> void: 
	...
	tower_visuals.play_shooting_animation()
